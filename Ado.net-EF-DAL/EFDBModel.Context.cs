...
namespace Ado.net_EF_DAL
{
    ...
    public partial class ProjectXConStr : DbContext
    {
        ...
        public virtual ObjectResult<string> uspDeleteFaculty(Nullable<int> pSNo)
        {
        ...
        public virtual ObjectResult<string> uspUpdateFaculty(Nullable<int> pSNo, string name)
        {
            var pSNoParameter = pSNo.HasValue ?
                new ObjectParameter("PSNo", pSNo) :
                new ObjectParameter("PSNo", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("uspUpdateFaculty", pSNoParameter, nameParameter);
        }
    }
}
